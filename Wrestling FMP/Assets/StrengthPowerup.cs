...
public class StrengthPowerup : MonoBehaviour
{
    ...
    public IEnumerator PickupPlayer1()
    {
        ...
        Debug.Log("Picked Up!");
        playerDamage.GetComponent<DamageManager>().damageMultiplier += 4; 
    ...
    //    Debug.Log("Picked Up!");
    //    player2.GetComponent<DamageManager>().damageMultiplier = 5;
    ...
    //    Debug.Log("Picked Up!");
    //    player3.GetComponent<DamageManager>().damageMultiplier = 5;
    ...
    //    Debug.Log("Picked Up!");
    //    player4.GetComponent<DamageManager>().damageMultiplier = 5;
