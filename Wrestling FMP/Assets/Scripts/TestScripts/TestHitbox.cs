...
public class TestHitbox : MonoBehaviour
{
    ...
    public PlayerMovementFinal playerMovementFinal;
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if (collision.gameObject.tag == "Enemy")
        {
            ...
            if (playerMovementFinal.isFacingRight == true)
            {
                ...
                player.GetComponent<EnemyKnockback>().DoKnockBack(/*hitstun,*/ newKnockback /*hitHorizontal, hitVertical*/);
